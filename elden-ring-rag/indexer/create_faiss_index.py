...
class EmbeddingsIndexer:
    ...
    def create_faiss_index(self):
        if not self.combined_df.empty:
            ...
            faiss.write_index(index, os.path.join(self.output_directory, "embeddings_index_flatl2.faiss"))
...
def main():
    ...
    indexer = EmbeddingsIndexer(input_directory, output_directory)
    indexer.process()
    print("FlatL2 Embedding indexing and mapping saved successfully.")
